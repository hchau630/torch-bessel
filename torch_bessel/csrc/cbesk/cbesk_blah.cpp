/* fortran/cbesk/cbesk.f -- translated by f2c (version 20240504).
...
/* Subroutine */ int cbesk_blah(complex *z__, real *fnu, integer *kode, integer *
	n, complex *cy, integer *nz, integer *ierr)
{
    ...
    /* Builtin functions */
    double r_imag(complex *), c_abs(complex *), sqrt(doublereal), log(
	    doublereal);
    ...
    static integer nuf;
    static real tol, alim, elim, fnul;
    extern /* Subroutine */ int cacon_(complex *, real *, integer *, integer *
	    , integer *, complex *, integer *, real *, real *, real *, real *,
	     real *), cbknu_(complex *, real *, integer *, integer *, complex 
	    *, integer *, real *, real *, real *), cbunk_(complex *, real *, 
	    integer *, integer *, integer *, complex *, integer *, real *, 
	    real *, real *), cuoik_(complex *, real *, integer *, integer *, 
